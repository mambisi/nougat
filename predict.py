...
def get_args():
    ...
    parser.add_argument("--use-tpu", action="store_true", help="Use TPU for processing if available.")
...
def main():
    ...
    model = move_to_device(model, bf16=not args.full_precision, cuda=args.batchsize > 0, xla=args.use_tpu)
    if args.batchsize <= 0:
